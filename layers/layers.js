...
lyr_Medaglionifemminilipunto_3.set('fieldAliases', {'fid': 'fid', 'N.CAT.': 'N.CAT.', 'Edificio': 'Edificio', 'Ambiente': 'Ambiente', 'Parete': 'Parete', 'Stile': 'Stile', 'Elemento': 'Elemento', 'Descrizion': 'Descrizion', 'Bibliograf': 'Bibliograf', 'Immagine': 'Immagine', });
...
lyr_Medaglionifemminilipunto_3.set('fieldImages', {'fid': 'TextEdit', 'N.CAT.': 'TextEdit', 'Edificio': 'TextEdit', 'Ambiente': 'TextEdit', 'Parete': 'TextEdit', 'Stile': 'TextEdit', 'Elemento': 'TextEdit', 'Descrizion': 'TextEdit', 'Bibliograf': 'TextEdit', 'Immagine': 'ExternalResource', });
...
lyr_Medaglionifemminilipunto_3.set('fieldLabels', {'fid': 'hidden field', 'N.CAT.': 'header label - visible with data', 'Edificio': 'no label', 'Ambiente': 'header label - visible with data', 'Parete': 'header label - visible with data', 'Stile': 'header label - always visible', 'Elemento': 'hidden field', 'Descrizion': 'header label - visible with data', 'Bibliograf': 'header label - visible with data', 'Immagine': 'header label - visible with data', });
